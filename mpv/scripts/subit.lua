...
o = {
    key = "d",
    path = "/usr/bin/subliminal",    -- absolute path to subliminal if not on PATH
    languages = "cs", -- list of IETF languages to search
    ...
    opensubtitles = "shadowmaker_88:Ragnarok_1",
